...
<html class="no-js">
  ...
  <body  data-spy="scrollbar" data-target=".navbar">
	...
	<div class="container">
        ...
        <section id="follow" class="fill">
			...
			<div class="span3">
			    <h3>The Team:</h3>
			    <h3 style="color:#000000">Kunjan Dhingra<br>
							Priyanka Ghosh<br>
							Pushkar Raj</h3>
			...
			<div class="offset3">
			    <h3>Idea Person:</h3>
			    <h3 style="color:#000000">Nisha Thompson</h3>
			</div>

			<div class="offset3">
			    <h3>Mentors:</h3>
			    <h3 style="color:#000000">Guneet Singh Narula</h3>
			</div>
